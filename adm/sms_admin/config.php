...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="cf_admin_hp">관리자번호<strong class="sound_only"> 필수</strong></label></th>
        <td>
            <input type="text" name="cf_admin_hp" value="<?php echo $sms5['cf_admin_hp']; ?>" id="cf_admin_hp" required class="frm_input required" size="60"> "," 로 구분해 주세요.
        </td>
    </tr>
    </tbody>
    </table>
