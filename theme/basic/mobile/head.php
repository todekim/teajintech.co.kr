...
<div id="wrapper">
    ...
    <div id="container">
    <?php if (!defined("_INDEX_")) { ?><h2 id="container_title" class="top" title="<?php echo get_text($g5['title'.($lang_type=="ko"?"":"_".$lang_type)]); ?>"><?php echo get_head_title($g5['title'.($lang_type=="ko"?"":"_".$lang_type)]); ?></h2><?php } ?>
