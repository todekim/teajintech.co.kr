...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
        ...
        <div class="write_div">
            <label for="wr_1" class="sound_only">휴대폰</label>
            <input type="text" name="wr_1" value="<?php echo $write[wr_1] ?>" id="wr_1" class="frm_input full_input" maxlength="100" placeholder="휴대폰번호">
        </div>
