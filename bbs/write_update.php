...
// 유튜브 관련 필드
$wr_link_yt_1 = '';
if (isset($_POST['wr_link_yt_1'])) {
    $wr_link_yt_1 = substr($_POST['wr_link_yt_1'],0,1000);
    $wr_link_yt_1 = trim(strip_tags($wr_link_yt_1));
    $wr_link_yt_1 = preg_replace("#[\\\]+$#", "", $wr_link_yt_1);
}

$wr_link_yt_2 = '';
if (isset($_POST['wr_link_yt_2'])) {
    $wr_link_yt_2 = substr($_POST['wr_link_yt_2'],0,1000);
    $wr_link_yt_2 = trim(strip_tags($wr_link_yt_2));
    $wr_link_yt_2 = preg_replace("#[\\\]+$#", "", $wr_link_yt_2);
}

$wr_link_yt_3 = '';
if (isset($_POST['wr_link_yt_3'])) {
    $wr_link_yt_3 = substr($_POST['wr_link_yt_3'],0,1000);
    $wr_link_yt_3 = trim(strip_tags($wr_link_yt_3));
    $wr_link_yt_3 = preg_replace("#[\\\]+$#", "", $wr_link_yt_3);
}

$wr_link_yt_4 = '';
if (isset($_POST['wr_link_yt_4'])) {
    $wr_link_yt_4 = substr($_POST['wr_link_yt_4'],0,1000);
    $wr_link_yt_4 = trim(strip_tags($wr_link_yt_4));
    $wr_link_yt_4 = preg_replace("#[\\\]+$#", "", $wr_link_yt_4);
}

$wr_link_yt_5 = '';
if (isset($_POST['wr_link_yt_5'])) {
    $wr_link_yt_5 = substr($_POST['wr_link_yt_5'],0,1000);
    $wr_link_yt_5 = trim(strip_tags($wr_link_yt_5));
    $wr_link_yt_5 = preg_replace("#[\\\]+$#", "", $wr_link_yt_5);
}

$wr_title_yt_1 = '';
if (isset($_POST['wr_title_yt_1'])) {
    $wr_title_yt_1 = substr($_POST['wr_title_yt_1'],0,1000);
    $wr_title_yt_1 = trim(strip_tags($wr_title_yt_1));
    $wr_title_yt_1 = preg_replace("#[\\\]+$#", "", $wr_title_yt_1);
}

$wr_title_yt_2 = '';
if (isset($_POST['wr_title_yt_2'])) {
    $wr_title_yt_2 = substr($_POST['wr_title_yt_2'],0,1000);
    $wr_title_yt_2 = trim(strip_tags($wr_title_yt_2));
    $wr_title_yt_2 = preg_replace("#[\\\]+$#", "", $wr_title_yt_2);
}

$wr_title_yt_3 = '';
if (isset($_POST['wr_title_yt_3'])) {
    $wr_title_yt_3 = substr($_POST['wr_title_yt_3'],0,1000);
    $wr_title_yt_3 = trim(strip_tags($wr_title_yt_3));
    $wr_title_yt_3 = preg_replace("#[\\\]+$#", "", $wr_title_yt_3);
}

$wr_title_yt_4 = '';
if (isset($_POST['wr_title_yt_4'])) {
    $wr_title_yt_4 = substr($_POST['wr_title_yt_4'],0,1000);
    $wr_title_yt_4 = trim(strip_tags($wr_title_yt_4));
    $wr_title_yt_4 = preg_replace("#[\\\]+$#", "", $wr_title_yt_4);
}

$wr_title_yt_5 = '';
if (isset($_POST['wr_title_yt_5'])) {
    $wr_title_yt_5 = substr($_POST['wr_title_yt_5'],0,1000);
    $wr_title_yt_5 = trim(strip_tags($wr_title_yt_5));
    $wr_title_yt_5 = preg_replace("#[\\\]+$#", "", $wr_title_yt_5);
}
// ------------------------------------------------
...
if ($w == '' || $w == 'r') {
    ...
    if(preg_match('/^b_[0-9]{1,2}/', $_POST['bo_table'])){
        ...
        for($i = 1; $i < 6; $i++){
            ...
            $link = ${"wr_link_yt_".$i};
            $title = ${"wr_title_yt_".$i};

            $sql .= "wr_link_yt_".$i." = '$link', ";
            $sql .= "wr_title_yt_".$i." = '$title', ";
